 ...
 * 
 * WHEN      RESPONSIBLE
 * 24.01.03  Dominic Ullmann (DUL), dul@elca.ch
 * 
...
namespace omg.org.CORBA {
    ...
    /// <summary>this class is the base class for all corba system exceptions mapped from IDL</summary>
    ...
    public class UNKNOWN : AbstractCORBASystemException { 
        ...
        public UNKNOWN(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class BAD_PARAM : AbstractCORBASystemException { 
        ...
        public BAD_PARAM(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class NO_MEMORY : AbstractCORBASystemException { 
        ...
        public NO_MEMORY(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class IMP_LIMIT : AbstractCORBASystemException { 
        ...
        public IMP_LIMIT(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class COMM_FAILURE : AbstractCORBASystemException {
        ...
        public COMM_FAILURE(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class INV_OBJREF : AbstractCORBASystemException {
        ...
        public INV_OBJREF(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class NO_PERMISSION : AbstractCORBASystemException {
        ...
        public NO_PERMISSION(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class INTERNAL : AbstractCORBASystemException {
        ...
        public INTERNAL(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class MARSHAL : AbstractCORBASystemException { 
        ...
        public MARSHAL(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class INITALIZE : AbstractCORBASystemException { 
        ...
        public INITALIZE(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class NO_IMPLEMENT : AbstractCORBASystemException {
        ...
        public NO_IMPLEMENT(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class BAD_TYPECODE : AbstractCORBASystemException { 
        ...
        public BAD_TYPECODE(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class BAD_OPERATION : AbstractCORBASystemException { 
        ...
        public BAD_OPERATION(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class NO_RESOURCES : AbstractCORBASystemException { 
        ...
        public NO_RESOURCES(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class NO_RESPONSE : AbstractCORBASystemException { 
        ...
        public NO_RESPONSE(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class PERSIST_STORE : AbstractCORBASystemException {
        ...
        public PERSIST_STORE(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class BAD_INV_ORDER : AbstractCORBASystemException { 
        ...
        public BAD_INV_ORDER(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class TRANSIENT : AbstractCORBASystemException { 
        ...
        public TRANSIENT(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class FREE_MEM : AbstractCORBASystemException { 
        ...
        public FREE_MEM(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class INV_IDENT : AbstractCORBASystemException { 
        ...
        public INV_IDENT(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class INV_FLAG : AbstractCORBASystemException { 
        ...
        public INV_FLAG(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class INTF_REPOS : AbstractCORBASystemException { 
        ...
        public INTF_REPOS(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class BAD_CONTEXT : AbstractCORBASystemException { 
        ...
        public BAD_CONTEXT(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class OBJ_ADAPTER : AbstractCORBASystemException {
        ...
        public OBJ_ADAPTER(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class DATA_CONVERSION : AbstractCORBASystemException {
        ...
        public DATA_CONVERSION(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class OBJECT_NOT_EXIST : AbstractCORBASystemException { 
        ...
        public OBJECT_NOT_EXIST(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class TRANSACTION_REQUIRED : AbstractCORBASystemException {
        ...
        public TRANSACTION_REQUIRED(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class INV_POLICY : AbstractCORBASystemException { 
        ...
        public INV_POLICY(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class CODESET_INCOMPATIBLE : AbstractCORBASystemException { 
        ...
        public CODESET_INCOMPATIBLE(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class TRANSACTION_MODE : AbstractCORBASystemException { 
        ...
        public TRANSACTION_MODE(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class TRANSACTION_UNAVAILABLE : AbstractCORBASystemException { 
        ...
        public TRANSACTION_UNAVAILABLE(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class REBIND : AbstractCORBASystemException { 
        ...
        public REBIND(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class TIMEOUT : AbstractCORBASystemException { 
        ...
        public TIMEOUT(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
    ...
    public class BAD_QOS : AbstractCORBASystemException { 
        ...
        public BAD_QOS(int minor, omg.org.CORBA.CompletionStatus status) : base(minor, status) { }
