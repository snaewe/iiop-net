...
namespace Ch.Elca.Iiop.Tests
{
    ...
    public class IorTest
    {
        ...
        public void TestNonUsableProfileIncluded()
        {
            ...
            Ior ior = new Ior(iorString);
            Assert.AreEqual("wrong RepositoryId", "IDL:cmiV2/UserAccessV2:1.0", ior.TypID);
        ...
        public void TestParseAndRecreate()
        {
            ...
            Assert.AreEqual("ior not recreated", iorString.ToLower(),
                                   recreated.ToLower());
            ...
            Assert.AreEqual("ior2 not recreated", iorString2.ToLower(),
                                   recreated2.ToLower());
        }
