...
namespace Ch.Elca.Iiop.IntegrationTests {
    ...
    public class TestInterceptorInit : ORBInitializer {
        ...
        private TestIORInterceptor m_iorIntercept;        
        ...
        public TestIORInterceptor IorIntercept {
            get {
                return m_iorIntercept;
            }
        }
        ...
        public void pre_init(ORBInitInfo info) {
            ...
            m_requestIntercept = new TestRequestInterceptor(String.Empty, "request", codec);
            m_iorIntercept = new TestIORInterceptor(String.Empty, "ior", codec);
            info.add_server_request_interceptor(m_requestIntercept);
            info.add_ior_interceptor(m_iorIntercept);
        }
